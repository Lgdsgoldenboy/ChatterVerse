    ...
    return (
        <Card className="w-full max-w-sm">
            <CardHeader className="text-center">
                <CardTitle className="font-headline text-2xl">Log In to ChatterVerse</CardTitle>
            ...
            <CardFooter className="justify-center text-sm">
                <p>
                    ...
                    <Link href="/auth/signup" className="font-medium text-primary-foreground underline hover:text-primary-foreground/80">
                        Sign up
                    </Link>
                </p>
            </CardFooter>
